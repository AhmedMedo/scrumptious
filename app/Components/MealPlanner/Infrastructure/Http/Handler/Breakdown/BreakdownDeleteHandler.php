...
#[OA\Delete(
    path: '/api/v1/breakdowns/{uuid}/delete',
    description: 'Delete Meal Plan Breakdown',
    summary: 'Delete Meal Plan Breakdown',
    tags: ['Breakdown'],
    parameters: [
        new OA\Parameter(
            name: 'uuid',
...
class BreakdownDeleteHandler extends Handler
{
    ...
    public function __invoke(string $uuid): \Illuminate\Http\JsonResponse
    {
        try {
            ...
            return $this->successResponseWithMessage('Breakdown deleted successfully');
